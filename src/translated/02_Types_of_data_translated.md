...
### 2.2.1 两类数据  2.2.1 Two categories  
...
### 2.2.2 两个以上类别  2.2.2 More than two categories  
...
### 2.3.2 连续型数据  2.3.2 Continuous data  
...
## 2.4 其他数据类型  2.4 OTHER TYPES OF DATA  
...
### 2.4.3 比率和比例  2.4.3 Rates and ratios  
...
## 2.8 处理数字  2.8 DEALING WITH NUMBERS  
...
### 2.8.3 数字的四舍五入  2.8.3 Rounding numbers  
