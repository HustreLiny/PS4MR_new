# 10 组间比较—分类数据  10 Comparing groups - categorical data  
...
### 10.4.5 $a$ 和 $d$ 真的被忽略了吗？  10.4.5 Are a and d really ignored？  
...
## 10.7 $2\times 2$ 频数表—两个比例的比较  10.7  $2\times 2$  FREQUENCY TABLES - COMPARISON OF TWO PROPORTIONS  
...
### 10.7.2 小样本 - Fisher精确检验  10.7.2 Small samples - Fisher's exact test  
...
### 10.7.3 Fisher精确检验—数学原理和实例  10.7.3 Fisher's exact test - mathematics and worked example  
...
### 10.7.5 $2 \times 2$ 表格—配对样本  10.7.5  $2 \times 2$  tables - paired samples  
...
### 10.8.2 有序分类  10.8.2 Ordered categories  
...
#### (b) 方法与实例  (b) Method and worked example  
...
#### (c) 定性有序分组  (c) Qualitatively ordered groups  
...
#### (d) 替代方法—Mann-Whitney 检验  (d) Alternative approach - the Mann-Whitney test  
...
## 10.9 带有有序类别的大型表格  10.9 LARGE TABLES WITH ORDERED CATEGORIES  
...
## 10.10 $k \times k$ 表格—配对变量的分析  10.10 $k \times k$ TABLES - ANALYSIS OF MATCHED VARIABLES  
...
## 10.11 比较风险  10.11 COMPARING RISKS  
...
### 10.11.2 回顾性研究—优势比  10.11.2 Retrospective study - the odds ratio  
...
### 10.11.3 组合多个 $2 \times 2$ 表  10.11.3 Combining several  $2 \times 2$  tables  
