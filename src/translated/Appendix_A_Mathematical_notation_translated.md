...
样本中，我们写成 $x_{4}$。在前面的例子中，$x_{4}$ 代表第四个人的死亡年龄。  
...
括号用于组合表达式，通常涉及加法或减法，其中整个表达式是更复杂  
...
样本均值或某些其他估计统计量的标准误。它是衡量此类估计不确定性的一种指标，用于推导总体值的置信区间。符号 $SE(b)$ 或 $SE_{b}$ 表示“b的标准误”。  
