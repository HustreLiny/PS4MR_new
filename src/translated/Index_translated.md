...
e N510 e\* N511 超声心动图 300, 397 关注效应 83, 165, 166, 169, 455  
...
胃冷冻 441 高斯, C. F. 51 高斯分布 见 正态分布 婴儿性别 49, 71-2, 177 全科医疗 7 全科医生 (GP) 年龄-性别登记 7 转诊 99 几何平均数 22, 37-8, 62, 164, 202 胎龄 42 与出生体重 266, 310, 326, 425 孕三烯酮 227 眼镜 216, 254-7 球蛋白 288 葡萄糖 172-3, 177-8, 292, 300-3, 306-9, 310-18, 320, 323 拟合优度 174 另见 具体方法 高塞特, W. S. 181 移植物抗宿主病 (GvHD) 361, 395  
...
独立组 180 独立观察 230, 282, 318 独立变量 见 预测变量 推断，统计 5, 71, 169, 490 亦见 样本，作为总体的估计 无限 N510, N513 炎症性肠病 359 红外刺激 (IRS) 233- 5, 252- 3 输入格式 114- 16 意向性治疗分析 464 观察者间变异 见 观察者 四分位数间距 33 评估者间一致性 见 观察者 交互作用 330, 331, 351, 354, 449, 467 截距 302, 312, 315, 316, 320 国际相关 290- 1, 298 插值 33, 38 结果解释 5, 8, 81, 94, 174, 177, 337, 442, 471- 3, 482, 489- 90 干预研究 152 肠易激综合征 504 缺血性心脏病 7, 358  
...
均值 21, 33, 37, 38, 41, 171, 221, 222, 423- 4, 430, N506  
...
P值 166, 175, 271, 344, 345, 465, 473, 485, 498, N511, N512 调整后 221 比较 467, 486 精确 168, 171, 176, 196, 253 解释 167-9, 177, 222-3, 429, 485, 489 局限性 174-5 过度依赖 169-70 呈现 175, 176-7, 220, 221, 487 双侧或单侧 170-1, 177, 214 另见 假设检验；统计显著性 红细胞压积 (PCV) 288, 348 疼痛 16, 38-9, 233-5, 441 配对数据 180, 486, 490 另见 组间比较  
...
预试验 460 PImax 21-2, 23, 28, 35, 40, 109 安慰剂 450-1, 452 安慰剂效应 451 研究计划 75, 483, 484 容积描记法 364 胸腔积液 444 绘制数据 见 图表 泊松分布 66-8, 70-1, 145, 246 多导生理描记仪 437 多项式回归 310 总体 5, 50 另见 样本 猪肉 297 阳性预测值 410-13, 415-16, 419 阳性结果 170, 489 后验概率 416 功效 169, 170, 261, 450, 465, 469 与样本量 169, 170, 189, 393, 455-60, 474, 484-5 幂 N507-8 子痫前期 476 数据精度 487 估计值精度 80, 83, 465, 487 数值精度 17, 18, 70-1, 487-8 虚假精度 42, 121, 487-8 预测 277, 340, 410 另见 回归 预测区间 307, 315, 316, 319, 320, 321 Cox回归中的预测变量 388, 389, 392 线性回归中的预测变量 301, 303, 317 逻辑回归中的预测变量 352, 355 多元回归中的预测变量 336-7, 339-46, 348, 349-51 泼尼松龙 178, 273-4 妊娠 95, 101, 124, 423, 484 妊娠期血压 426 妊娠期高血压 275, 476 妊娠期尿酸 39 妊娠期体重增加 6 统计资料的呈现 3, 494 方差分析 220-2 卡方检验 271  
...
# 统计资料的呈现（续）  Presentation of statistical material (cont.)  
...
数据 18, 42-5, 221, 271, 433  
data 18, 42- 5, 221, 271, 433  

假设检验 175, 176-7, 220, 221, 487  
...
预后指数 337, 347-8, 390-1, 414 参见 风险评分  
...
# 随机化 (续)  Randomization (corr.)  

分层 88- 9 加权 87 另见 临床试验，随机化 极差 31, 221 中心 33, 57 检查 124, 149 四分位数间距 33 正常/参考 见 参考区间 秩 13, 22, 33, 173, 185, 205, 213- 14, 286, 365 秩相关 265, 279, 285- 8, 295- 6, 297 秩方法 见 非参数方法 秩和检验 见 Wilcoxon 检验 率 14 比值 14, 202 雷诺现象 467 回忆偏倚 94- 5 受试者工作特征 (ROC) 曲线 417- 18 倒数 N508 变换 141- 5 直肠活检 359 红细胞体积 435 审稿 478, 492, 493, 494 参考区间 76, 419- 26 置信区间 422- 3, 425 与年龄的关系 423- 6 样本选择 420, 426 样本量 420, 422, 425 使用经验 (百分) 位数 420, 421- 3, 425 使用正态分布 420- 3 使用变换 420- 1 参考范围 见 参考区间 回归 与相关性的区别 277, 320- 1 线性 见 线性回归 逻辑 见 逻辑回归 多元 见 多元回归 多项式 310 呈现 319- 20, 351, 487- 8, 489 针对生存数据 见 Cox 回归 均值回归 285  
...
将部分与整体关联 285 相对频率 27, 29, 51 相对风险 266- 8, 271 放松反应 214 结果的可靠性 4, 81 肾衰竭 127, 226 重复性 401, 402, 419 重复测量 80, 327- 31, 434 重复观测 82, 217, 331- 3, 401 代表性样本 6, 75, 78, 82, 100, 153, 160, 368, 451, 490 再现性 331- 3 研究 争议 3, 5, 96, 102 步骤 5 发现的有效性 4 残差 在方差分析中 207, 328, 330, 334 在线性回归中 301, 303- 6, 308, 313, 423 在多元回归中 341, 344, 346- 7, 349, 351 残差图 303- 6, 346- 7, 351 残差标准差 209, 221, 308, 313, 319, 320, 346, 351 残差方差 207, 302, 308, 313, 329, 330 残差变异 328 呼吸肌力量 22, 336 呼吸频率 438 呼吸道感染 438 反应率 7, 490 治疗反应 387 响应变量 301 静息代谢率 (RMR) 322, 361 结果 矛盾的 3, 5, 96, 102 检查 114 解释 5, 8, 81, 94, 174, 177, 337, 442, 471- 3, 482, 489- 90 呈现 18, 176- 7, 220- 2, 271, 393- 4 晶状体后纤维增生症 441- 2 回顾性研究 74, 76, 91, 484  
...
随机 6, 60, 82, 153, 155- 7, 279, 283  
random 6, 60, 82, 153, 155- 7, 279, 283  

代表性 6, 75, 78, 82, 100, 153, 160, 368, 451, 490  
...
临床试验 443, 447, 452, 454, 455- 60, 464, 474, 484  
for clinical trial 443, 447, 452, 454, 455- 60, 464, 474, 484  

比较比例 187, 189, 248, 253  
...
与功效 169, 170, 189, 393, 455- 60, 474, 484- 5  
...
和样本量 143, 154, 161, 181, 248, 253, 378  
...
散点图/散点图 40, 43, 113, 125, 133, 279, 299, 319, 342, 397, 469, 488, 489  
...
重复测量（续） 汇总测量 429-31, 433 婴儿性别 49, 71-2, 177 Shapiro-Francia $W^{\prime}$ 检验 139, 291, 303-6, 330 检验表 538-9 Shapiro-Wilk $W$ 检验 139, 166, 279, 291 鞋码 229, 261-5, 319 兄弟姐妹性别比 273 符号检验 186-7, 204, 205, 240, 336 显著性水平 $(\pmb {\alpha})$ 168, 344-5 显著性检验 见 假设检验 显著 见 统计学显著性 有效数字 320 模拟 120, 155, 157 歌声 273 正弦曲线 434-5 样本大小 见 样本量 大小与生长 101 偏度 36-8, 136 另见 分布，偏态 皮肤问题 474 睡眠困难 236-9 回归线斜率 见 线性回归 吸烟 2, 7, 95, 96, 357, 459 与癌症 93, 275 与高血压 352-5 被动吸烟 91 与牙齿萌出 31 与尿可替宁排泄 226 另见 香烟 打鼾与心脏病 264 与高血压 352-5 社会阶层 7 金硫苹果酸钠 (SA) 45, 274-5 软件 见 计算机程序 空间失调 223 航天飞机 223 Spearman, C. 286 Spearman 等级相关系数 $(r_{s})$ 286-8, 295-6, 297 检验表 530 特异性 410, 412, 413, 415-16, 418, 419, 420 眼镜 216, 254-7  
...
血压计 79, 148 电子表格 112 平方 N507 平方根 N508 平方根变换 41, 143, 145, 202 疾病分期 12, 96, 172, 375 标准差 (SD) 33-6, 37, 38, 41, 42, 153, 154, 155, 171, 181, 398, 422-4, 457, N506 展示 42, 222, 487, 488, 490 不同研究组中相似 143, 180, 192, 197-8, 199-201, 206 另见 方差 标准差分数 425 标准误 (SE) 百分位数 422 均值差 160-1, 190, 192 比例差 162, 233, 234, 237, 240 估计值 (SEE) 320 展示 221-2, 487, 488, 490 回归中 306, 314-15, 319, 336, 347 样本均值 154, 160, 162, 221-2 样本比例 161-2, 165, 230 生存比例 370, 378 用于构建置信区间 165, 235 标准正态离差 见 正态分数 标准化差异 457, 458, 459 标准化死亡率 14 统计分析 见 数据分析 论文中的统计错误 4, 261, 477-8, 479, 491, 498 分析中 261, 385-7, 401-2, 426-7, 477, 482, 486-7 后果 453, 482, 491-2 设计中 473-4, 477-8, 482-5 执行中 485 解释中 482, 489-90 遗漏 7, 474, 482, 490-1 展示中 453-4, 487-9, 491 原因 492  
...
作者统计学指南 494, 498 临床试验 494 流行病学研究 494 统计推断 见 推断 统计建模 171, 173-4, 317 另见 模型；回归 统计学显著性 168-71, 174, 455-6, 472, 489 与临床重要性 170, 177 另见 假设检验；P 值 统计学家 75, 102, 145, 282, 493 统计学概论 1-3 医学研究中 4-8, 174, 478-81 医学中 3-4 不信任 3 滥用 vii, 481, 486 另见 论文中的统计错误 使用情况回顾 455, 465-6, 473, 479-91 范围 5-8 教学 vii 茎叶图 28 阶梯函数 369, 386 逐步回归 340-5, 349-50, 355, 389 B组链球菌 224 链霉素 440, 478 应激性生活事件 269-70 中风 451 搏出量 (SV) 397-400 Stuart-Maxwell 检验 266 Student 181 Student's t 检验 见 t 检验 研究设计 见 设计 亚组分析 466-7, 472, 473, 486 受试者 见 样本选择 下标 N505-6 子集分析 见 亚组分析 自杀 91 硫氧化指数 (SI) 45, 228, 274-5 平方和 35, 208, 218-20, 311 汇总测量/统计量 429-31, 433, 487, 488 另见 数据描述 求和 (Σ) 35, N508  
...
太阳镜 216 上标 N507 手术 450 乳腺癌 365, 375 心脏搭桥 207 监测偏倚 99 调查 见 观察性研究 生存时间数据 16, 125, 365-94 精算方法 371 组间比较 371-6, 379-85, 386-7 计算 366, 370, 375, 377, 379, 389, 391 置信区间 369-70, 371, 376, 378-9, 383-5, 391 Cox 回归 387-93 设计考虑 393 图形展示 369, 376, 385, 386-7, 394 风险 388, 390-1 风险函数 388, 392 风险比 375-6, 383-4, 385, 390 不正确分析 385-7 Kaplan-Meier 生存曲线 368-71, 377-9, 384, 385, 386, 394 生命表 368, 371, 394 对数秩检验 371-5, 379-83, 385, 386, 394 平均生存时间 386 中位生存时间 369, 376, 384-5, 386 结果展示 393-4 预后指数 390-1 比例风险回归 387-93 治疗反应 387 样本量 376, 378, 386, 455 生存比例/概率 366, 367-71, 376, 377-9, 384, 386-7, 388, 390-1 甜味剂 102 游泳者 250-2, 269 系统分配 446, 485, 494  
...
t 分布 165, 166, 181-2, 184, 219, 294, 296, 316, 340, N512 与正态分布比较 181  
t distribution 165, 166, 181- 2, 184, 219, 294, 296, 316, 340, N512 compared to Normal distribution 181  

t 分布（续） 表 521-2 t 检验 方差分析后 211, 219-20 修正 211 单样本 184-5, 191, 219, 397, 469 配对 191, 199, 202, 221, 326, 328, 397, 402 展示 220-2 两样本（非配对） 192, 194, 197, 198, 199, 205, 206, 207, 209, 221, 319, 333, 426, 467, 469 $\mathbf{T_{4}}$ 细胞 126, 143, 200-5, 225 $\mathbf{T_{8}}$ 细胞 200-5 表格 42, 488 频率 见 频率表 统计表 514-45 分布尾部 36, 58, 139, 166-7, 171, 181, 255, 257, 421 滑石粉 444 茶 102 牙齿 萌出年龄 31 龋齿、缺失和充填 500 一岁时数量 350 温度 41 检验统计量 166, 167, 221, 487 睾酮 273 理论分布 50-71, 171, 175 治疗试验 见 临床试验 甲状腺素 198 结（并列秩） 173, 197, 265, 295, 334, 335 时间 变化 101-2 隐藏效应 148-9 峰值 430 相关数据 283, 426-33 序列方法 360 趋势 148, 283, 488 跑一英里时间 317 滴度 145 肺总量 (TLC) 364 转录错误 122-3, 124, 125 变换 N510 数据 36, 41-2, 108, 143, 180, 199, 204, 279, 303, 346, 350, 392, 420  
...
变换（续） 线性 41 对数 36-7, 41-2, 60-2, 126, 136, 143-5, 199, 200-3, 205, 287, 303-6, 392, 400-1, N510 logit 145-6, 352 非线性 41 正态化 61-3, 133-6, 143-5, 199, 207, 421, N510 比例 145-6, 352 原理 143-5 倒数 143-5 平方根 41, 143, 145, 202 跨二尖瓣容积流量 (MF) 397-400 移植 骨髓 361, 395 心肺 364 肾脏 124, 145, 360 肝脏 368 肺 364 梯形法则 433 治疗分配 86, 88, 442-7, 450, 461, 485 治疗-周期交互作用 448, 467, 469 趋势 见 线性趋势；非线性趋势 真阳性 357 胰蛋白酶 212-13, 219-20 肿瘤 反应 387 大小 89, 145, 396 双胞胎 288-90, 295 双侧（双尾）检验 167, 170-1, 177, 214 I 类错误 169, 211, 457-9, N511 II 类错误 169, 457-9, N512 另见 功效  
...
溃疡性结肠炎 359 超声 82, 101, 267, 331, 484 紫外线辐射 216 不确定性 3, 48, 145, 153, 157, 169, 307, 321, 421 非对照试验 441, 478 水下直升机逃生 334-6 失业 103  
...
描述 22- 31, 398, 419, 487, 489  
description of 22- 31, 398, 419, 487, 489  

解释 297, 308- 9, 316, 340, 347  
...
在不同研究组中相似 143, 180, 192, 197-8, 199-201, 206  
